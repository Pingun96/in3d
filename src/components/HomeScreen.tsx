  ...
  return (
    <div className="flex flex-col w-full h-full bg-[#111] overflow-hidden relative">
        ...
        {isPrinting ? (
          <div className="w-full flex h-full items-center">
             <div className="w-[30%] flex items-center justify-center">
               {/* Progress Circle */}
               <div className="relative w-[160px] h-[160px] flex items-center justify-center drop-shadow-lg">
                 ...
                 <div className="absolute w-[120px] h-[120px] rounded-full overflow-hidden flex flex-col items-center justify-center bg-[#1a1a1a]">
                    {coverImage ? (
                 ...
                 <div className="absolute -bottom-2 bg-[#111] px-2 py-0.5 rounded-full border border-[#333]">
                    <span className="text-sm font-bold text-[#00e676]">{printProgress || 0}%</span>
                 </div>
               </div>
             </div>
             <div className="w-[70%] pl-10 flex flex-col gap-5">
                <div className="text-2xl text-white font-medium truncate w-full" title={printSubtask}>
                  {printSubtask || "Không xác định"}
                </div>

                <div className="flex gap-16 mt-2">
                  <div className="flex flex-col gap-1.5">
                    <span className="text-[#888] text-sm uppercase tracking-wider">Trạng thái</span>
                  ...
                  <div className="flex flex-col gap-1.5">
                    <span className="text-[#888] text-sm uppercase tracking-wider">Còn lại</span>
                    <span className="text-[#00e676] text-xl font-medium">{printTimeRemaining || 0} phút</span>
                  </div>
                  <div className="flex flex-col gap-1.5">
                    <span className="text-[#888] text-sm uppercase tracking-wider">Dự kiến xong lúc</span>
                    <span className="text-white text-xl font-medium">{estimatedEndTime}</span>
                  </div>
                </div>
             </div>
          </div>
          ...
          <>
            ...
            <div className="w-[60%] pl-10">
              <div className="border-l-[3px] border-[#00e676] pl-6 h-[50px] flex flex-col justify-center gap-1">
                <div className="text-[#e0e0e0] font-medium text-[24px] leading-tight">
                  Máy in đã sẵn sàng!
                </div>
                <div className="text-[#888] text-sm">Hãy chọn một mẫu in để bắt đầu.</div>
              </div>
            </div>
          </>
        )}
      ...
      <div className="w-full h-[140px] flex gap-[10px] px-8 pb-10">
        ...
        <div 
          className={`${boxClass} flex-[1.6] justify-center items-center gap-3 px-4 relative overflow-hidden group`}
          onClick={() => onControlPrint('print')}
        >
          <img src="/benchy_transparent.png" alt="Benchy" className="h-[60px] object-contain drop-shadow-[0_5px_10px_rgba(0,0,0,0.5)] group-hover:scale-105 transition-transform duration-300" />
          <span className="text-[#e0e0e0] text-sm font-medium z-10">Print Files</span>
        </div>
